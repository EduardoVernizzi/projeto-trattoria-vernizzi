...
const Header = () => {
  ...
  const handleFinishPurchase = () => {
    ...
    pagamentoSelect.style.maxWidth = "90%"; // Garante responsividade
    pagamentoSelect.style.boxSizing = "border-box"; // Evita estouro de padding
    ...
    // Limita para 3 números e só permite dígitos
    ...
    dinheiroInfo.addEventListener("input", (e) => {
      let val = e.target.value.replace(/\D/g, "").slice(0, 5); // Máximo 5 dígitos
      let int = val.padStart(3, "0"); // Garante pelo menos 3 dígitos para fazer a divisão
